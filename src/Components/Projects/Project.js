...
const Project = () => {
     const images = [
        ...
        { srce: image3,name:"Personal Portfolio",para:"Designed and developed a personal portfolio website to showcase my skills, projects, and resume. The site highlights my work as a developer and acts as a central hub for potential employers or collaborators to learn more about me.",Tech:"React-Js",link:"https://github.com/sanjaysurendran56/Edutrack"},
